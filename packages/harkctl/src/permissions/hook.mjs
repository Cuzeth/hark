import { askHarkPermission, permissionSummary, uniqueIdempotencyKey } from "./hark.mjs";
...
export function hookDecision(_agent, allow, message = "Denied through Hark.") {
  return {
    hookSpecificOutput: {
...
export async function handlePermissionHook(agent, input, ask = askHarkPermission) {
  if (input?.hook_event_name !== "PermissionRequest") {
    return hookDecision(agent, false, "Invalid permission request; denied by Hark policy.");
  }
